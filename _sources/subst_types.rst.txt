...
.. |limits_arg_descr| replace:: If a :py:class:~`zfit.core.base.limits.Range` is given, it is used as limits. Otherwise arguments to instantiate a Range class can be given as follows.|limits_init|
