...
class Space(
    ...
    def __init__(
        ...
        _arg1=None,  # legacy behavior, see below
        _arg2=None,  # legacy behavior, see below
        *,
        ...
        args = []  # legacy behavior, equivalent of *args, but cannot use *args for composite tensors in TFP
...
@tfp.experimental.auto_composite_tensor(omit_kwargs=("name", "label", "_arg1", "_arg2", "binning", "axes", "limits"))
