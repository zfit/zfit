...
Re_alpha_perp_0 = FitParameter("Re_alpha_perp_0", param_mean_H[0] , -0.01, 0.01, 0.00001)
Re_alpha_para_0 = FitParameter("Re_alpha_para_0", param_mean_H[1] , -0.01, 0.01, 0.00001)
Re_alpha_zero_0 = FitParameter("Re_alpha_zero_0", param_mean_H[2] , -0.01, 0.01, 0.00001)
Im_alpha_perp_0 = FitParameter("Im_alpha_perp_0", param_mean_H[3] , -0.01, 0.01, 0.00001)
Im_alpha_para_0 = FitParameter("Im_alpha_para_0", param_mean_H[4] , -0.01, 0.01, 0.00001)
Im_alpha_zero_0 = FitParameter("Im_alpha_zero_0", param_mean_H[5] , -0.01, 0.01, 0.00001)

Re_alpha_perp_1 = FitParameter("Re_alpha_perp_1", param_mean_H[6] , -0.01, 0.01, 0.0001)
Re_alpha_para_1 = FitParameter("Re_alpha_para_1", param_mean_H[7] , -0.01, 0.01, 0.0001)
Re_alpha_zero_1 = FitParameter("Re_alpha_zero_1", param_mean_H[8] , -0.01, 0.01, 0.0001)
Im_alpha_perp_1 = FitParameter("Im_alpha_perp_1", param_mean_H[9] , -0.01, 0.01, 0.0001)
Im_alpha_para_1 = FitParameter("Im_alpha_para_1", param_mean_H[10], -0.01, 0.01, 0.0001)
Im_alpha_zero_1 = FitParameter("Im_alpha_zero_1", param_mean_H[11], -0.01, 0.01, 0.0001)

Re_alpha_perp_2 = FitParameter("Re_alpha_perp_2", param_mean_H[12], -0.01, 0.01, 0.0001)
Re_alpha_para_2 = FitParameter("Re_alpha_para_2", param_mean_H[13], -0.01, 0.01, 0.0001)
Im_alpha_perp_2 = FitParameter("Im_alpha_perp_2", param_mean_H[14], -0.01, 0.01, 0.0001)
Im_alpha_para_2 = FitParameter("Im_alpha_para_2", param_mean_H[15], -0.01, 0.01, 0.0001)
...
alpha_perp_0 = Complex(Re_alpha_perp_0, Im_alpha_perp_0)
alpha_para_0 = Complex(Re_alpha_para_0, Im_alpha_para_0)
alpha_zero_0 = Complex(Re_alpha_zero_0, Im_alpha_zero_0)

alpha_perp_1 = Complex(Re_alpha_perp_1, Im_alpha_perp_1)
alpha_para_1 = Complex(Re_alpha_para_1, Im_alpha_para_1)
alpha_zero_1 = Complex(Re_alpha_zero_1, Im_alpha_zero_1)

alpha_perp_2 = Complex(Re_alpha_perp_2, Im_alpha_perp_2)
alpha_para_2 = Complex(Re_alpha_para_2, Im_alpha_para_2)
alpha_zero_2 = Complex(Re_alpha_zero_2, Im_alpha_zero_2)

alpha_perp_3 = Complex(Re_alpha_perp_3, Im_alpha_perp_3)
alpha_para_3 = Complex(Re_alpha_para_3, Im_alpha_para_3)
alpha_zero_3 = Complex(Re_alpha_zero_3, Im_alpha_zero_3)

alpha_perp_4 = Complex(Re_alpha_perp_4, Im_alpha_perp_4)
alpha_para_4 = Complex(Re_alpha_para_4, Im_alpha_para_4)
alpha_zero_4 = Complex(Re_alpha_zero_4, Im_alpha_zero_4)

alpha_perp_5 = Complex(Re_alpha_perp_5, Im_alpha_perp_5)
alpha_para_5 = Complex(Re_alpha_para_5, Im_alpha_para_5)
