...
from zfit.physics.flavour.rare_decays.bToKstarll.non_local_hadronic.nlh_parameters import alpha_para_5
...
def H_perp(q2):
    ...
    return (CastComplex((1.0 - z_q2 * z_Jpsi2) * (1.0 - z_q2 * z_psi2S2) /
            ...
            poly5C(alpha_perp_0, alpha_perp_1, alpha_perp_2,
...
def H_para(q2):
    ...
    return (CastComplex((1.0 - z_q2 * z_Jpsi2) * (1.0 - z_q2 * z_psi2S2) /
                        ((z_q2 - z_Jpsi2) * (z_q2 - z_psi2S2))) *
            poly5C(alpha_para_0, alpha_para_1, alpha_para_2,
...
def H_zero(q2):
    ...
    return (CastComplex((1.0 - z_q2 * z_Jpsi2) * (1.0 - z_q2 * z_psi2S2) /
                        ((z_q2 - z_Jpsi2) * (z_q2 - z_psi2S2))) *
            poly4C(alpha_zero_0, alpha_zero_1, alpha_zero_2,
