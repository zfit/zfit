...
def test_partial_integral():
    ...
    integral_x_tf = cosxy2.partial_integrate(x=data, limits=xspace, options=options)
    integral_y_tf = cosxy2.partial_integrate(x=data, limits=yspace, options=options)
